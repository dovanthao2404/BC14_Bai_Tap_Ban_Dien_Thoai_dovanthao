...
if (typeof listProductInCart !== "Array" && listProductInCart) {
  listProductInCart = JSON.parse(listProductInCart);
}
...
const delegationCart = (e) => {
  ...
  if (dataAction === "delete") {
    listProductInCart = listProductInCart.filter((phone) => {
      return phone.id !== idPhone;
    })
    renderView(listProductInCart);
    localStorage.setItem("listProductInCart", listProductInCart)
