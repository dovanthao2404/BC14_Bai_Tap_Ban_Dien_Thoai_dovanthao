...
const delegationListPhoneView = (e) => {
  if (e.target.getAttribute("data-action") === "add") {
    ...
    if (document.querySelector(".notifiSuccess").style.display === "block") {
      document.querySelector(".notifiSuccess").style.display = "none";
    }
    document.querySelector(".notifiSuccess").style.display = "block";
    setTimeout(() => {
      document.querySelector(".notifiSuccess").style.display = "none";
    }, 3000)
